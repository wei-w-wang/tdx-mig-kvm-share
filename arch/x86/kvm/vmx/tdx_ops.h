					     ...
					     u64 *rdx)
{
	...
	ret = seamcall_ret(TDH_EXPORT_STATE_IMMUTABLE, &in);
	*rdx = in.rdx;
					     ...
					     u64 *rcx, u64 *rdx)
{
	...
	ret = seamcall_ret(TDH_IMPORT_STATE_IMMUTABLE, &in);
	*rcx = in.rcx;
	*rdx = in.rdx;
...
static inline u64 tdh_import_commit(hpa_t tdr)
{
	...
	return seamcall(TDH_IMPORT_COMMIT, &in);
}
...

{
	...
	ret = seamcall_saved_ret(TDH_EXPORT_MEM, &in);
	*rcx = in.rcx;
	*rdx = in.rdx;
				 ...
				 u64 *rcx)
{
	...
	ret = seamcall_saved_ret(TDH_IMPORT_MEM, &in);
	*rcx = in.rcx;
				      ...
				      u64 *rdx)
{
	...
	ret = seamcall_ret(TDH_EXPORT_STATE_VP, &in);
	*rdx = in.rdx;
				      ...
				      u64 *rdx)
{
	...
	ret = seamcall_ret(TDH_IMPORT_STATE_VP, &in);
	*rcx = in.rcx;
	*rdx = in.rdx;
...
static inline u64 tdh_import_end(hpa_t tdr)
{
	...
	return seamcall(TDH_IMPORT_END, &in);
}
				   ...
				   u64 mig_stream_info)
{
	...
	return seamcall(TDH_EXPORT_ABORT, &in);
}
